...
![**Uncertainty and Ranking of RF evaluated for all participants.** **a**) Plotted relationship between the uncertainty of the forest in each prediction (x-axis) and delta value (y-axis) for all partici-pants. $\Delta$Value was computed for each transfer-phase trial using the end ($Q$) beliefs that participants had about each face at the end of the learning phase. Forest uncertainty is defined as the proportion of trees saying ‘yes! the choice on this trial was optimal’. When this ratio is bellow 0.5 the forest will predict ‘no’ (sub-optimal), otherwise the prediction is ‘yes! the choice on this trial was optimal’ (optimal). $R^2$=adjusted $R^2$. **b**) Plotted ranking of the ROI’s in their contribution to the predictive accuracy of RF evaluated with all participants.\label{sFigure 3}](_png/sFigure3.png)
