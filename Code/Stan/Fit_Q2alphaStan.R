...
load('./Behavior/data/Rawdata_andStanlistforfitting.rdat') # Qdat=observed raw data, stan_file=used for fitting
RL_learn50000<-stan(file='./Code/Stan/Qstan_alpha2.stan',data=stan_file,iter=50000,chains=4)
