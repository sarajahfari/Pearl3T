...
CBase=c("response","subject_id",'conflict',
     ...
     "DLPFCposterior","preSMAsmall",'Q.diff',control_regions)
...
for (block in BLOCK)
{
  ...
  # traditional
	...
	save(list=c('conf','IMP.name','IMP.Daccuracy','AUC','PREDICT'),
	    file=paste('~/Documents/Pearl3T/NEW/RF/RF_forests/R2R/PAUC_FORESTN43_onetraintest_4cregions','_ntree',NTREE,'_block',block,
