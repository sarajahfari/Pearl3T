...
setwd("/Users/sarajahfari/Documents/Github/Pearl3T/RF/RF_forests/Forests_onetraintest218_100seeds2000trees")
...
# this loop takes the 1000 2000treeforests, and evaluates the ranking across all
# this to ensure that we are not reporting a random ranking score
...
# if (Type=='ALL') pdf('All_1000it_confsubje11regions_mTRY52000.pdf',3,2.2) else
